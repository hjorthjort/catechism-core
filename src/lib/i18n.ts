export const languages = [
  ...
  { code: 'sv', flag: '🇸🇪', label: 'Swedish', nativeLabel: 'Svenska', direction: 'ltr' },
...
const partTranslations = {
  ...
  sv: {
    Prologue: 'Prolog',
    'Profession of Faith': 'Trosbekännelsen',
    'Celebration of the Christian Mystery': 'Firandet av det kristna mysteriet',
    'Life in Christ': 'Livet i Kristus',
    'Christian Prayer': 'Den kristna bönen',
  },
  it: {
    Prologue: 'Prologo',
...
export const uiStrings: Record<AppLanguage, UiStrings> = {
  ...
  sv: {
    wordmarkKicker: 'CCC',
    wordmarkTitle: 'Samband i katekesen',
    navOverview: 'Översikt',
    navExplorer: 'Utforska',
    navTopNode: 'Viktigaste nod',
    homeEyebrow: 'Ett sätt att utforska sambanden i katekesen',
    homeTitle: 'Katekesen som ett navigerbart nätverk, inte bara en samling sidor.',
    homeLede:
      'Webbplatsen gör varje numrerat stycke till en nod, kartlägger inkommande och utgående länkar och låter dig växla mellan översikt och närläsning.',
    homeOpenGraph: 'Öppna grafen',
    homeViewSource: 'Visa källtexten',
    statParagraphs: 'Stycken',
    statInternalLinks: 'Interna länkar',
    statExternalRefs: 'Externa hänvisningar',
    featureGraphTitle: 'Läsning genom grafen',
    featureGraphBody: 'Zooma genom hela texten, förhandsvisa ett stycke och öppna valfri nod för läsning.',
    featureReferenceTitle: 'Kartläggning av hänvisningar',
    featureReferenceBody: 'Utgående länkar visar vart ett stycke pekar. Inkommande länkar visar var det åberopas.',
    featureRankTitle: 'PageRank',
    featureRankBody: 'Rangordningen uppskattar vilka stycken som är mest centrala i nätverket.',
    rankingEyebrow: 'De mest centrala styckena',
    rankingTitle: 'Högst rankade noder',
    explorerEyebrow: 'Utforska',
    explorerTitle: 'Sök',
    searchLabel: 'Sök',
    searchPlaceholder: 'Prova 2558, eukaristin, bön...',
    searchOpen: 'Öppna',
    searchRead: 'Läs',
    focusedNode: 'Se även',
    readParagraph: 'Läs stycket',
    paragraphNotFound: 'Stycket hittades inte',
    backToExplorer: 'Tillbaka till utforskaren',
    loadingTitle: 'Läser in katekesgrafen...',
    errorTitle: 'Grafdata kunde inte läsas in',
    sourceMaterial: 'Källmaterial',
    openSource: 'Öppna den svenska källtexten',
    officialVaticanText: 'Svensk källtext',
    vaticanBibleArchive: 'Vatican.va:s bibelarkiv',
    translatedWithAi: 'Översatt med AI',
    compareLabel: 'Jämför',
    languageSelector: 'Språkval',
    externalReferences: 'Externa hänvisningar',
    footnotes: 'Fotnoter',
    linksOut: 'Utgående länkar',
    linksIn: 'Inkommande länkar',
    returnToGraph: 'Tillbaka till grafen',
    localGraph: 'Lokal graf',
    localGraphBlurb: 'Två steg i varje riktning. Enkelriktade länkar visas med pilar.',
    graphZoom: 'Rulla för att zooma',
    graphPan: 'Dra för att panorera',
    graphClickDetail: 'Klicka på en nod för hela stycket',
    graphClickFollow: 'Klicka för att följa ett stycke',
    outgoing: 'utgående',
    incoming: 'inkommande',
    rank: 'Rankning',
    scripture: 'Skriften',
...
export const hierarchyWords = {
  ...
  sv: { part: 'Del', section: 'Avdelning', chapter: 'Kapitel', article: 'Artikel' },
