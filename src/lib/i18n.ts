...
type UiStrings = {
  ...
  openSource: string;
  officialVaticanText: string;
  vaticanBibleArchive: string;
  translatedWithAi: string;
  compareLabel: string;
...
export const uiStrings: Record<AppLanguage, UiStrings> = {
  en: {
    ...
    officialVaticanText: 'Official Vatican text',
    vaticanBibleArchive: 'Vatican.va Bible archive',
    translatedWithAi: 'Translated with AI',
  ...
  fr: {
    ...
    officialVaticanText: 'Texte officiel du Vatican',
    vaticanBibleArchive: 'Archive biblique Vatican.va',
    translatedWithAi: 'Traduit avec l’IA',
  ...
  de: {
    ...
    officialVaticanText: 'Offizieller Vatikantext',
    vaticanBibleArchive: 'Vatican.va Bibelarchiv',
    translatedWithAi: 'Mit KI ubersetzt',
  ...
  it: {
    ...
    officialVaticanText: 'Testo ufficiale del Vaticano',
    vaticanBibleArchive: 'Archivio biblico Vatican.va',
    translatedWithAi: 'Tradotto con IA',
  ...
  la: {
    ...
    officialVaticanText: 'Textus officialis Vaticani',
    vaticanBibleArchive: 'Archivum biblicum Vatican.va',
    translatedWithAi: 'Machina intellegenti versa',
    compareLabel: 'Compara',
    languageSelector: 'Selector linguae',
  ...
  es: {
    ...
    officialVaticanText: 'Texto oficial del Vaticano',
    vaticanBibleArchive: 'Archivo biblico de Vatican.va',
    translatedWithAi: 'Traducido con IA',
  ...
  pt: {
    ...
    officialVaticanText: 'Texto oficial do Vaticano',
    vaticanBibleArchive: 'Arquivo biblico Vatican.va',
    translatedWithAi: 'Traduzido com IA',
    compareLabel: 'Comparar',
  ...
  mg: {
    ...
    officialVaticanText: 'Lahatsoratra ofisialin’ny Vatican',
    vaticanBibleArchive: 'Tahirin-kevitra Baiboly Vatican.va',
    translatedWithAi: 'Nadika tamin’ny IA',
    compareLabel: 'Ampitahao',
    languageSelector: 'Fisafidianana fiteny',
  ...
  zh: {
    ...
    officialVaticanText: '梵蒂岡官方原文',
    vaticanBibleArchive: 'Vatican.va 聖經檔案',
    translatedWithAi: '由 AI 翻譯',
    compareLabel: '對照',
  ...
  ar: {
    ...
    officialVaticanText: 'النص الرسمي للفاتيكان',
    vaticanBibleArchive: 'ارشيف الكتاب المقدس Vatican.va',
    translatedWithAi: 'مترجم بالذكاء االصطناعي',
    compareLabel: 'قارن',
